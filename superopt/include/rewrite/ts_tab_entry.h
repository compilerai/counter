...
dshared_ptr<insn_db_t<src_insn_t, ts_tab_entry_t>> src_ts_tab_read_from_file(char const *file);
dshared_ptr<insn_db_t<dst_insn_t, ts_tab_entry_t>> dst_ts_tab_read_from_file(char const *file);
