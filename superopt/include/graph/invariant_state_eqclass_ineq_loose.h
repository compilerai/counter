...
class invariant_state_eqclass_ineq_loose_t : public invariant_state_eqclass_t<T_PC, T_N, T_E, T_PRED>
{
private:
  //all inclusive
...
public:
  invariant_state_eqclass_ineq_loose_t(expr_group_ref const &exprs_to_be_correlated, context *ctx) : invariant_state_eqclass_t<T_PC, T_N, T_E, T_PRED>(exprs_to_be_correlated, ctx)
  {
    this->compute_params();
  }

  invariant_state_eqclass_ineq_loose_t(istream& is, string const& inprefix/*, state const& start_state*/, context* ctx) : invariant_state_eqclass_t<T_PC, T_N, T_E, T_PRED>(is, inprefix/*, start_state*/, ctx)
  {
    this->compute_params();
  }
  ...
  virtual invariant_state_eqclass_t<T_PC, T_N, T_E, T_PRED> *clone() const override
  {
    ...
    return new invariant_state_eqclass_ineq_loose_t<T_PC, T_N, T_E, T_PRED>(*this);
  }
  ...
  /*static string invariant_state_eqclass_ineq_loose_from_stream(istream& is, context* ctx, list<nodece_ref<T_PC, T_N, T_E>> const &counterexamples, invariant_state_eqclass_t<T_PC, T_N, T_E, T_PRED>*& eqclass)
  {
