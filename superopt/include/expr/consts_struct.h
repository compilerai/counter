...
struct consts_struct_t
{
  ...
  string_ref get_local_addr_key(reg_type rt, allocstack_t const& allocstack, string const& srcdst_prefix) const;
  expr_ref get_local_addr(reg_type rt, allocstack_t const& allocstack, string const& srcdst_prefix) const;
  ...
  expr_ref get_rodata_size() const;
  ...
  string get_addr_ref(memlabel_ref const& mlr) const;
  ...
  memlabel_ref get_memlabel_ref_for_keyword(string keyword) const;
  ...
  bool is_rodata_size(expr_ref const& e) const;
  ...
  bool expr_is_hidden_reg(expr_ref const &e) const;
  ...
  string relevant_addr_refs_to_string(set<memlabel_ref> const &relevant_addr_refs) const;
  string read_relevant_addr_refs(ifstream &db, string const &line, set<memlabel_ref> &relevant_addr_refs);
  ...
  bool expr_is_local_id(expr_ref const &e, string const& srcdst_keyword) const;
  allocstack_t expr_get_local_id(expr_ref const &e, string const& srcdst_keyword) const;
  expr_ref compute_memzero() const;
  expr_ref get_memzero() const { return m_memzero; }
...
bool expr_is_consts_struct_constant(expr_ref e, consts_struct_t const &cs);
...
extern string g_rodata_keyword;
