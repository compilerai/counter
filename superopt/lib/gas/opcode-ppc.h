...
struct powerpc_operand
{
  ...
  //void (*extract_from_insn) (struct src_insn_t const *insn, int *invalid, int32_t *value, src_tag_t *tag, imm_modifier_t *imm_mod, unsigned *constant_val, src_tag_t *constant_tag, uint64_t *sconstants);
