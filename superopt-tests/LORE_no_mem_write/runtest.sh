...
compiler=clang  gen_commands_from_file  clang_oopsla_funcs_vec_nolpr   " --disable_loop_path_exprs  --disable_residual_loop_unroll --unroll-factor 8"    "8uf.BFS"  >> chaperon_commands_bfs
...
compiler=gcc    gen_commands_from_file  gcc_oopsla_funcs_vec_8uf_nolpr " --disable_loop_path_exprs --disable_residual_loop_unroll --unroll-factor 8"     "8uf.BFS"  >> chaperon_commands_bfs
...
compiler=clang   gen_commands_from_file_src_dst  clang_oopsla_funcs_hand     "--debug=oopsla_log --global-timeout 18000 --smt-query-timeout 300 "        "8uf.BFS"  >> chaperon_commands_bfs
...
compiler=gcc     gen_commands_from_file_src_dst  gcc_oopsla_funcs_hand       "--debug=oopsla_log --global-timeout 18000 --smt-query-timeout 300 "        "4uf.DFS"  >> chaperon_commands_dfs
...
compiler=clang  gen_commands_from_file  clang_oopsla_funcs_vec_nolpr   " --disable_loop_path_exprs  --disable_residual_loop_unroll --unroll-factor 8"    "8uf.DFS"  >> chaperon_commands_dfs
...
compiler=gcc    gen_commands_from_file  gcc_oopsla_funcs_vec_8uf_nolpr " --disable_loop_path_exprs --disable_residual_loop_unroll --unroll-factor 8"     "8uf.DFS"  >> chaperon_commands_dfs

binary=corr_mutations
 g_global_eqflags="--disable_dst_bv_rank --disable_src_bv_rank --disable_propagation_based_pruning --disable_all_static_heuristics"
compiler=gcc     gen_commands_from_file_src_dst  gcc_oopsla_funcs_hand_8uf       "--debug=oopsla_log --global-timeout 18000 --smt-query-timeout 300 "        "8uf.DFS"  >> chaperon_commands_dfs
compiler=clang   gen_commands_from_file_src_dst  clang_oopsla_funcs_hand     "--debug=oopsla_log --global-timeout 18000 --smt-query-timeout 300 "        "8uf.DFS"  >> chaperon_commands_dfs
