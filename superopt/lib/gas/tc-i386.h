...
void i386_md_convert_frag (bfd *abfd ATTRIBUTE_UNUSED, segT sec ATTRIBUTE_UNUSED,
                 fragS *fragP);
void i386_md_apply_fix (fixS *fixP, valueT *valP, segT seg ATTRIBUTE_UNUSED);
void md_operand_dummy (expressionS *e);
