...
typedef struct etfg_insn_edge_t {
  ...
  etfg_insn_edge_t(shared_ptr<tfg_edge const> const &e, vector<valtag_t> const &pcrels)
  : m_tfg_edge(e),
    m_pcrels(pcrels)
  {
  }
  ...
  bool etfg_insn_edge_stores_top_level_op_in_reg(exreg_group_id_t g, reg_identifier_t const &r,
...
typedef struct etfg_insn_t {
  ...
  void etfg_insn_set_tfg(tfg const *t)
  {
    //m_tfg = (const void *)t;
    m_ctx = t->get_context();
    m_start_state = make_shared<state const>(t->get_start_state());
  }
  /*const void *etfg_insn_get_tfg() const
  {
    return m_tfg;
  }*/
  shared_ptr<state const> const &etfg_insn_get_start_state() const
  {
  ...
  bool etfg_insn_stores_top_level_op_in_reg(exreg_group_id_t g, reg_identifier_t const &r,
...
private:
  context *m_ctx;
  shared_ptr<state const> m_start_state;
...
shared_ptr<eqspace::tfg> src_iseq_get_preprocessed_tfg(src_insn_t const *iseq, long iseq_len, regset_t const *live_out, size_t num_live_out, std::map<eqspace::pc, std::map<string_ref, expr_ref>> const &return_reg_map, context *ctx, eqspace::sym_exec &se);

size_t etfg_insn_get_size_for_exreg(etfg_insn_t const *insn, exreg_group_id_t group, reg_identifier_t const &r);
shared_ptr<eqspace::state const> etfg_pc_get_input_state(struct input_exec_t const *in, src_ulong pc);
...
bool etfg_iseq_stores_eq_comparison_in_reg(etfg_insn_t const *iseq, long iseq_len, exreg_group_id_t g, reg_identifier_t const &r);
bool etfg_iseq_stores_ult_comparison_in_reg(etfg_insn_t const *iseq, long iseq_len, exreg_group_id_t g, reg_identifier_t const &r);
bool etfg_iseq_stores_slt_comparison_in_reg(etfg_insn_t const *iseq, long iseq_len, exreg_group_id_t g, reg_identifier_t const &r);
bool etfg_iseq_stores_ugt_comparison_in_reg(etfg_insn_t const *iseq, long iseq_len, exreg_group_id_t g, reg_identifier_t const &r);
bool etfg_iseq_stores_sgt_comparison_in_reg(etfg_insn_t const *iseq, long iseq_len, exreg_group_id_t g, reg_identifier_t const &r);
