...
public:
  ...
  static std::vector<expr_ref> get_dst_fcall_args_for_fsignature(fsignature_t const& fsignature, expr_ref const& mem, expr_ref const& stackpointer, std::string const& graph_name, long& max_memlabel_varnum, expr_ref& dst_fcall_retval_buffer);
};
