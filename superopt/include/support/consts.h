...
#define WFCOND_ALLOCA_ADDR_GEQ_SP "-alloca-addr-geq-sp"
...
#define G_MEMLABEL_VAR_PREFIX_FOR_LOC "mlloc."
...
#define PRED_COMMENT_OUTGOING_EDGES_COVER_ALL_POSSIBILITIES "outgoing_edges_cover_all_possibilities."
#define PRED_COMMENT_DST_EDGECOND_PROVES_FALSE "dst_edge_composition_proves_false"

#define PRED_COMMENT_LINEAR "linear"
#define PRED_COMMENT_GUESS_MEMALLOCS_EQ "mem-allocs-equality"
#define PRED_COMMENT_GUESS_MEM_NONSTACK_EQ "memeq-nonstack"
...
#define PRED_COMMENT_GUESS_HOUDINI(s) s PRED_COMMENT_HOUDINI_GUESS_SUFFIX

#define EXPR_GROUP_NAME_BV_EQCLASS "expr-group-bvs"
...
#define EXPR_GROUP_NAME_LOCAL_SIZES_ARE_EQUAL "-local-sizes-are-equal"
...
#define EXPR_GROUP_NAME_SP_ML_LB_INEQ "-sp-ml-lb-ineq"
#define EXPR_GROUP_NAME_ML_LB_UB_INEQ "-ml-lb-ub-ineq"
#define EXPR_GROUP_NAME_ML_LB_UB_EQ "-ml-lb-ub-eq"
#define EXPR_GROUP_NAME_ML_LB_ADDR_EQ "-ml-lb-addr-eq"
#define EXPR_GROUP_NAME_DST_INEQ "dst-ineq"

#define PRED_COMMENT_GUESS_HOUDINI_REGION_AGREES_WITH_MEMLABEL PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_REGION_AGREES_WITH_MEMLABEL)
#define PRED_COMMENT_GUESS_HOUDINI_NONARG_LOCALS_ISCONTIGUOUS PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_NONARG_LOCALS_ISCONTIGUOUS)
#define PRED_COMMENT_GUESS_HOUDINI_NONARG_LOCALS_IS_PROBABLY_CONTIGUOUS PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_NONARG_LOCALS_IS_PROBABLY_CONTIGUOUS)
#define PRED_COMMENT_GUESS_HOUDINI_VARIABLY_SIZED_ALLOCA_SP_VERSIONS PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_VARIABLY_SIZED_ALLOCA_SP_VERSIONS)
#define PRED_COMMENT_GUESS_HOUDINI_LOCALS_LB_UB_AND_SP_VERSIONS PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_LOCALS_LB_UB_AND_SP_VERSIONS)
#define PRED_COMMENT_GUESS_HOUDINI_LOCALS_UB_UPPER_BOUND PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_LOCALS_UB_UPPER_BOUND)
#define PRED_COMMENT_GUESS_HOUDINI_ABSTRACT_MEMLABEL_ASSERTS PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_ABSTRACT_MEMLABEL_ASSERTS)
#define PRED_COMMENT_GUESS_HOUDINI_LOCAL_SIZES_ARE_EQUAL_SUFFIX PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_LOCAL_SIZES_ARE_EQUAL)
#define PRED_COMMENT_GUESS_HOUDINI_MEMLABEL_IS_ABSENT PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_MEMLABEL_IS_ABSENT)
#define PRED_COMMENT_GUESS_HOUDINI_SP_IN_STACK PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_SP_IN_STACK)
#define PRED_COMMENT_GUESS_HOUDINI_SP_BELOW_ISP PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_SP_BELOW_ISP)
#define PRED_COMMENT_GUESS_HOUDINI_SP_ML_LB_INEQ PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_SP_ML_LB_INEQ)
#define PRED_COMMENT_GUESS_HOUDINI_ML_LB_UB_INEQ PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_ML_LB_UB_INEQ)
#define PRED_COMMENT_GUESS_HOUDINI_ML_LB_UB_EQ PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_ML_LB_UB_EQ)
#define PRED_COMMENT_GUESS_HOUDINI_ML_LB_ADDR_EQ PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_ML_LB_ADDR_EQ)
#define PRED_COMMENT_GUESS_HOUDINI_DST_INEQ PRED_COMMENT_GUESS_HOUDINI(EXPR_GROUP_NAME_DST_INEQ)

#define CG_ASSUME_COMMENT(s) "cg-edge-assume-" s

#define CG_ASSUME_COMMENT_ALLOCA_PTR_EQ CG_ASSUME_COMMENT("alloca-ptr-eq")
#define CG_ASSUME_COMMENT_ALLOCA_SIZE_EQ CG_ASSUME_COMMENT("alloca-size-eq")
#define CG_ASSUME_COMMENT_UNKNOWN CG_ASSUME_COMMENT("unknown")

#define CORREL_ENTRY_APPLY_PREFIX "correl_entry_apply."
#define CORREL_ENTRY_LADDER_STARTPC_NODE_STRING "correl_entry_ladder_startpc_node"
#define CORREL_ENTRY_LADDER_JUST_STARTED_STRING "correl_entry_ladder_just_started"
#define CORREL_ENTRY_LADDER_ENUM_IMPLIED_CHILDREN_STRING "correl_entry_ladder_enum_implied_children"
#define CORREL_ENTRY_LADDER_DONE_STRING "correl_entry_ladder_done"
