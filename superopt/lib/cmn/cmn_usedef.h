...
cmn_usedef_tab_read_from_file(char const *file)
{
  ...
  ASSERT(line);
  shared_ptr<insn_db_t<cmn_insn_t, usedef_tab_entry_t>> usedef_tab = make_shared<insn_db_t<cmn_insn_t, usedef_tab_entry_t>>(DEFAULT_USEDEF_TAB_HASH_SIZE);
  ASSERT(usedef_tab);
...
static shared_ptr<insn_db_t<cmn_insn_t, usedef_tab_entry_t>>
