...
long src_iseq_eliminate_nops(struct src_insn_t *iseq, long iseq_len);
...
long src_iseq_canonicalize(struct src_insn_t *iseq, long iseq_len);
...
//    int size, bool var);
src_ulong pc_copy(src_ulong orig_pc, long copy_id);
long pc_get_copy_id(src_ulong pc);
src_ulong pc_get_orig_pc(src_ulong pc);
