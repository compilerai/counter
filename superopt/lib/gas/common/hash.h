...
extern struct hash_control *gas_hash_new (void);
...
extern const char *gas_hash_insert (struct hash_control *,
...
extern void *gas_hash_replace (struct hash_control *, const char *key,
			 void *value);

/* Find an entry in a hash table, returning its value.  Returns NULL
   if the entry is not found.  */

extern void *gas_hash_find (struct hash_control *, const char *key);
...
extern void *gas_hash_delete (struct hash_control *, const char *key, int);
...
extern void gas_hash_print_statistics (FILE *, const char *name,
				   struct hash_control *);
