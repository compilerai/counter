...
long dst_iseq_eliminate_nops(struct dst_insn_t *iseq, src_ulong* dst_insn_pcs, long iseq_len);
void dst_iseq_convert_pcs_to_inums(struct dst_insn_t *dst_iseq, dst_ulong const *pcs,
...
long dst_iseq_connect_end_points(struct dst_insn_t *iseq, long len, size_t iseq_size,
    ...
    i386_as_mode_t mode);
long dst_iseq_canonicalize(struct dst_insn_t *iseq, src_ulong* canon_insn_pcs, long iseq_len);
...
int dst_iseq_disassemble_with_bin_offsets(struct dst_insn_t *dst_iseq, uint8_t *bincode, int binsize,
    struct vconstants_t *vconstants[], nextpc_t *nextpcs,
    long *num_nextpcs, dst_ulong* bin_offsets, i386_as_mode_t i386_as_mode);
