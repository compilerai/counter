...
public:
  ...
  static memlabel_t memlabel_local(allocstack_t const& local_id/*, variable_size_t size*/);
  static memlabel_t memlabel_heapalloc(allocstack_t const& allocstack);
  ...
  static bool memlabel_contains_only_stack_or_local(memlabel_t const *ml);
  ...
  static memlabel_t get_memlabel_for_addr_ref_ids(set<memlabel_ref> const &addr_ref_ids, eqspace::consts_struct_t const &cs, eqspace::graph_symbol_map_t const &symbol_map, eqspace::graph_locals_map_t const &locals_map);
  ...
  static set<memlabel_ref> eliminate_stack(set<memlabel_ref> const &mls);
  ...
  bool operator==(memlabel_t const &other) const;
  bool operator!=(memlabel_t const &other) const { return !this->operator==(other); }
  set<memlabel_ref> get_atomic_memlabels() const;
  void set_to_empty_mem() { m_type = MEMLABEL_MEM; m_alias_set.clear(); }
  static memlabel_t memlabel_empty();
  int memlabel_is_arg() const;
  void memlabel_eliminate_args();
  void memlabel_eliminate_stack();
  void memlabel_eliminate_heap();
  void memlabel_eliminate_readonly_symbols();
  void memlabel_eliminate_rodata();
  void memlabel_replace_readonly_memlabels_with_rodata_memlabel();
  ...
  bool memlabel_is_farg_local(allocstack_t& local_id, string const& fname) const;
  bool memlabel_is_heap_alloc() const;
  ...
  memlabel_t memlabel_difference(memlabel_t const& other) const;

  static bool memlabel_set_contains_stack(set<memlabel_ref> const& memlabel_set);
