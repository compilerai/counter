...
symbolS *ppc_md_undefined_symbol (char *name ATTRIBUTE_UNUSED);
void ppc_md_apply_fix3 (fixS *fixP, valueT * valP, segT seg ATTRIBUTE_UNUSED);
char *ppc_md_atof (int type, char *litp, int *sizep);
